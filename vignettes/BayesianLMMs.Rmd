...
```{r fitmodel1}              
fixEfFit <- stan(file = "S1_fixEf.stan", 
                 data = stanDat, 
                 iter = 2000, chains = 4)

#save(list="fixEfFit",file="../data/S1_fixEfFit.Rda",
#     compress="xz")
```
...
ranIntFit <- stan(file = "S2_ranInt.stan", data = stanDat, 
                  iter = 2000, chains = 4)
```
...
ranIntSlpNoCorFit <- stan(file = "S3_ranIntSlpNoCor.stan", data = stanDat, 
                     iter = 2000, chains = 4)

#save(list = "ranIntSlpNoCorFit",
#     file = "../data/S3_ranIntSlpNoCorFit.Rda",
#     compress = "xz")
```
...
# 1. Compile and fit model.
ranIntSlpFit <- stan(file = "S4_ranIntSlp.stan", data = stanDat, 
                     iter = 2000, chains = 4)

#save(list = "ranIntSlpFit",
#     file = "../data/S4_ranIntSlpFit.Rda",
#     compress = "xz")
```
...
# 3. Fit the model.
matrixFit <- stan(file = "S5_matrixModel.stan", data = stanDat,
                  iter = 2000, chains = 4)
# 4. Save the result.
#save(list = "matrixFit",
#     file = "../data/S5_matrixFit.Rda",
#     compress = "xz")
```
...
# 1. Compile and fit model.
pp <- stan(file = "S6_pp.stan", data = stanDat, 
           warmup = 500, iter = 750, chains = 1)

#save(list = "pp",file = "../data/S6_pp.Rda",
#     compress = "xz")
```
...
# 5. Fit the model.
factorialFit <- stan(file="S7_factorialModel.stan",data=stanDat,
                     iter=2000, chains=4)
# 6. Save the result.
#save(list="factorialFit",
#     file="../data/S7_factorialFit.Rda",
#     compress="xz")
```
